...
namespace TensorFlowLite
{
    ...
    public sealed class PoseLandmarkDetect : BaseVisionTask
    {
        public class Result
        {
            ...
            // public Texture SegmentationTexture { get; internal set; } = null; // Disabled - missing PoseSegmentation
        }
        ...
        // private readonly PoseSegmentation segmentation; // Disabled - missing dependency
        ...
        public PoseLandmarkDetect(Options options)
        {
            ...
            if (options.enableSegmentation)
            {
                ...
                // segmentation = new PoseSegmentation(info, options.compute); // Disabled - missing dependency
            }
        ...
        {
            // segmentation?.Dispose(); // Disabled - segmentation not implemented
        ...
        private void UpdateResult()
        {
            ...
            // Segmentation disabled - missing PoseSegmentation dependency
            /*
            if (options.enableSegmentation)
            {
